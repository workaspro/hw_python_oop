...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        """Получить количество затраченных калорий."""
        self.RUN_COEFF_MULTIPL = 18
        self.RUN_COEFF_SUBTRACT = 20
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        """Получить количество затраченных калорий."""
        self.SW_COEFF_MULTIPL_FOR_WEIGHT = 0.035
        self.SW_COEFF_MULTIPL = 0.029
        self.SW_COEFF_MULTIPL_FOR_MEAN_SPEED = 2
...
class Swimming(Training):
    ...
    def get_spent_calories(self) -> float:
        """Получить количество затраченных калорий."""
        self.SWIM_COEFF_FOR_MEAN_SPEED = 1.1
        self.SWIM_COEFF_MULTIPL = 2
